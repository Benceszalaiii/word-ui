    ...
    <DocsPage>
      ...
      <DocsContent>
        ...
        <CodeBlock
          code={code}
          language="tsx"
          filename="hooks/use-cursor-theme.ts"
        />
        ...
        <div className="self-start">
          ...
          <DocsDescription>
            <span className="inline-code">setTheme</span>: Current color setter.
            Values are to be HEX colors.
          </DocsDescription>
          <DocsDescription>
            <span className="inline-code">setCursorDefault</span>: Sets the
            cursor color back to default.
          </DocsDescription>
          <DocsDescription>
            <span className="inline-code">defaultTheme</span>: The default color
            applied to the cursor
          </DocsDescription>
        </div>
        <CodeBlock
          language="tsx"
          code={usage}
          filename="components/componentwithcursor.tsx"
        />
        <div className="h-32" />
      </DocsContent>
    </DocsPage>
